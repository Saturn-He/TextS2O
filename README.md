...
CUDA_VISIBLE_DEVICES=6 torchrun --nproc_per_node=1 --master_port=29506 main_jit.py --evaluate_gen --resume /NAS_data/hjf/JiTcolor/checkpoints/SAR2Opt/controlJiT/round3 --sar_test_path /NAS_data/yjy/Parallel-GAN-main/Parallel-GAN-main/datasets/sar2opt/testA --output_dir /NAS_data/hjf/JiTcolor/outputs/SAR2Opt/controlJiT/round3 --img_size 512 --gen_bsz 8 --keep_outputs
...
CUDA_VISIBLE_DEVICES=6 torchrun --nproc_per_node=1 --master_port=29507 main_jit.py --evaluate_gen --resume /NAS_data/hjf/JiTcolor/checkpoints/GF3/controlJiT/round3 --sar_test_path /NAS_data/yjy/GF3_High_Res/testA --output_dir /NAS_data/hjf/JiTcolor/outputs/GF3/controlJiT/round3 --img_size 256 --gen_bsz 8 --keep_outputs
...
CUDA_VISIBLE_DEVICES=6 torchrun --nproc_per_node=1 --master_port=29508 main_jit.py --evaluate_gen --resume /NAS_data/hjf/JiTcolor/checkpoints/scene/controlJiT/round3 --sar_test_path /data/hjf/Dataset/SEN12_Scene/testA --output_dir /NAS_data/hjf/JiTcolor/outputs/scene/controlJiT/round3 --img_size 256 --gen_bsz 8 --keep_outputs
